...
export default function FreelanceServices() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-zinc-500 dark:bg-zinc-800">
      ...
      <Card className="container py-8 px-4 w-full max-w-2xl bg-zinc-500 dark:bg-zinc-700 ">
        <CardHeader>
        ...
        <CardFooter className="flex justify-center">
          <Button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out transform hover:scale-105">
